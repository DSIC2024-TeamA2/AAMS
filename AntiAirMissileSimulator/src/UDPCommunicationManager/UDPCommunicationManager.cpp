...
UDPCommunicationManager::start()
{
	...
	scenarioInfo = this->registerMsg(_T("ScenarioInfo"));
	airThreatInfo = this->registerMsg(_T("AirThreatInfo"));
	commMsgHandler.setNOM(simulationStatusInfoMsg);
	commMsgHandler.setNOM(scenarioInfo);
	commMsgHandler.setNOM(airThreatInfo);
...
UDPCommunicationManager::stop()
{
	...
	this->deleteMsg(airThreatInfo);
	this->deleteMsg(simulationStatusInfoMsg);
	this->deleteMsg(scenarioInfo);
